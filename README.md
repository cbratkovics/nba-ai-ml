...
| Pass rates over repeated runs (`agent-eval.yml`, 5 per date; row rendered from the report) | <!-- pass-rates -->incomplete: 20 of 25 briefs completed (4 of 5 dates; 0 rate-limited; 1 dates measured under an older golden set, not counted); of those, grounding 20 of 20, golden 20 of 20<!-- /pass-rates -->; see [docs/agent.md](docs/agent.md#reliability) |
